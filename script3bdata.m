...
to=1000; %end indice in your data
windowradius=400; %window radius for runPreds function
p=200;
%parameters for user to change
...
for i=2:2
    ...
    save(strcat(resultsdir,file,'800results.mat'), 'predictions', 'actual', 'dumb', 'ARPpredictions', 'predictions', 'SSEal', 'SSEdumb', 'SSEARP', 'opt', 'param', 'variance');
    saveas(h,strcat(resultsdir,file,'800results.jpg'), 'jpg');
