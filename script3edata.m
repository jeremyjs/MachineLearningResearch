...
realdata=['data sources/facebook.mat';'data sources/ibm.mat     ';'data sources/intel.mat   ';'data sources/yahoo.mat   ';'data sources/nokia.mat   '];
from=1; %beginning indice in your data
to=600; %end indice in your data
windowradius=200; %window radius for runPreds function
p=100;
%parameters for user to change

%run on synthetic data
resultsdir='real data results1000once/';
...
for i=5:5
    ...
    [predictions, ARPpredictions, xs, actual, dumb, SSEal, SSEARP, SSEdumb, opt, param, variance]=runPredstrainonce(celldata{i}, from, to, windowradius, p);
    ...
    save(strcat(resultsdir,file,'400results.mat'), 'predictions', 'actual', 'dumb', 'ARPpredictions', 'predictions', 'SSEal', 'SSEdumb', 'SSEARP', 'opt', 'param', 'variance');
    saveas(h,strcat(resultsdir,file,'400results.jpg'), 'jpg');
