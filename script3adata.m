...
to=150; %end indice in your data
windowradius=50; %window radius for runPreds function
p=25;
%parameters for user to change
...
for i=1:1
    ...
    save(strcat(resultsdir,file,'results.mat'), 'predictions', 'actual', 'dumb', 'ARPpredictions', 'predictions', 'SSEal', 'SSEdumb', 'SSEARP', 'opt', 'param', 'variance');
